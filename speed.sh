...
speed() {
    ...
    if [ "$REGION" = "india" ]; then
        speed_test '62966' 'Noida, UP'
        speed_test '43324' 'Noida, UP'
        speed_test '28420' 'Noida, UP'
        speed_test '45938' 'Noida, UP'
        speed_test '36995' 'Gr. Noida, UP'
        speed_test '25811' 'Gr. Noida, UP'
        speed_test '10020'  'Gurgaon, HR'
        speed_test '24161' 'Mumbai, MH'
        speed_test '6879' 'Mumbai, MH'
        speed_test '29658' 'Delhi, DL'
        speed_test '34104' 'Delhi, DL'
        speed_test '21706' 'Delhi, DL'
